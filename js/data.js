...
window.WORKS = [
  /* ---------------- Available ---------------- */
  { id: "a-storm-is-brewing", title: "A Storm Is Brewing", img: "a-storm-is-brewing-16x20-acrylic-on-canvas", size: [20, 16], medium: "Acrylic on canvas", category: "shore", status: "available", price: 400, featured: true,
    blurb: "Summer thunderheads build over a pale beach, with rain already falling far out on the water." },
  { id: "birdhouses-of-dauphin-island", title: "Birdhouses of Dauphin Island", img: "birdhouses-of-dauphin-island-36x48-acrylic-on-gallery-wrapped-canvas", size: [48, 36], medium: "Acrylic on gallery-wrapped canvas", category: "harbors", place: "Dauphin Island, Alabama", status: "available", price: 900, featured: true,
    blurb: "A row of brightly painted stilt houses under a sunburst sky." },
  { id: "kaleidoscope-beach", title: "Kaleidoscope Beach", img: "kaleidoscope-beach-16x20-acrylic-on-canvas", size: [20, 16], medium: "Acrylic on canvas", category: "shore", status: "available", price: 400, featured: true,
    blurb: "Waves roll onto a pebbled shore under a golden sky." },
  { id: "boardwalk-to-paradise", title: "Boardwalk to Paradise", img: "boardwalk-to-paradise-18x24-acrylic-on-canvas", size: [24, 18], medium: "Acrylic on canvas", category: "shore", status: "available", price: 400, featured: true,
    blurb: "A sun-bleached boardwalk crosses the dunes to a small house at the water's edge." },
  { id: "stormy-light", title: "Stormy Light", img: "stormy-light-36x36-acrylic-on-canvas-framed", size: [36, 36], medium: "Acrylic on canvas, framed", category: "shore", status: "available", price: 900, featured: true,
    blurb: "A lighthouse stands against heavy surf and dark storm clouds." },
  { id: "under-the-sea", title: "Under the Sea", img: "under-the-sea-4x6ft-mixed-media-on-gallery-wrapped-canvas", size: [72, 48], sizeLabel: "48 × 72″", medium: "Mixed media on gallery-wrapped canvas", category: "flora", status: "available", price: 1200, featured: true,
    blurb: "Sea turtles glide above a textured coral reef in this large mixed media piece." },
  { id: "sandy-shores", title: "Sandy Shores", img: "sandy-shores-24x30-acrylic-on-gallery-wrapped-canvas", size: [30, 24], medium: "Acrylic on gallery-wrapped canvas", category: "shore", status: "available", price: 600, featured: true,
    blurb: "A dune fence curves toward the water as the sun sets." },
  { id: "walking-on-top-of-the-world", title: "Walking on Top of the World", img: "walking-on-top-of-the-world-16x20-acrylic-on-canvas", size: [20, 16], medium: "Acrylic on canvas", category: "shore", status: "available", price: 350, featured: true,
    blurb: "A boy walks across a tidal flat that reflects the sky." },
  { id: "rockport", title: "Rockport", img: "rockport-10x30-acrylic-on-canvas", size: [30, 10], medium: "Acrylic on canvas", category: "harbors", place: "Rockport, Massachusetts", status: "available", price: 450, featured: true,
    blurb: "A panoramic view across the harbor to the red fishing shack, with a dory in still water." },
  { id: "boardwalk-of-dauphin-island", title: "Boardwalk of Dauphin Island", img: "boardwalk-of-dauphin-island-24x36-acrylic-on-canvas", size: [36, 24], medium: "Acrylic on canvas", category: "shore", place: "Dauphin Island, Alabama", status: "available", price: 500,
    blurb: "A weathered boardwalk winds through dune grass toward a pavilion under a big Gulf sky." },
  { id: "dauphin-island-sunset", title: "Dauphin Island Sunset", img: "dauphin-island-sunset-24x36-acrylic-on-canvas", size: [36, 24], medium: "Acrylic on canvas", category: "shore", place: "Dauphin Island, Alabama", status: "available", price: 500,
  ...
  { id: "oysters", title: "Oysters", img: "oysters-12x12-acrylic-in-gallery-wrapped-canvas", size: [12, 12], medium: "Acrylic on gallery-wrapped canvas", category: "tables", status: "available", price: 300,
    blurb: "Oysters on the half shell with slices of lemon." },
  { id: "blue-crab-boil", title: "Blue Crab Boil", img: "blue-crab-boil-8x10-acrylic-on-canvas", size: [8, 10], medium: "Acrylic on canvas", category: "tables", status: "available", price: 300,
    blurb: "A pot of blue crabs painted with quick, loose strokes." },
  { id: "mardi-gras-cheer", title: "Mardi Gras Cheer", img: "marci-gras-cheer-12x12-acrylic-on-gallery-wrapped-canvas", size: [12, 12], medium: "Acrylic on gallery-wrapped canvas", category: "tables", status: "available", price: 200,
    blurb: "Masks, feathers and beads at a balcony party in purple, green and gold." },
  { id: "peacock-nest", title: "Peacock Eggs", img: "peacock-nest-20x20-acrylic-on-gallery-wrapped-canvas", size: [20, 20], medium: "Acrylic on gallery-wrapped canvas", category: "flora", status: "available", price: 400,
    blurb: "Blue eggs in a nest of peacock feathers." },
  { id: "sir-peter-rabbit", title: "Sir Peter Rabbit", img: "sir-peter-rabbit-12x12-acrylic-on-canvas", size: [12, 12], medium: "Acrylic on canvas", category: "flora", status: "available", price: 250, featured: true,
    blurb: "A hare in a waistcoat and cameo, painted as a formal portrait." },
  { id: "jellyfish", title: "Jellyfish", img: "jellyfish-18x24-oil-on-canvas", size: [18, 24], medium: "Oil on canvas", category: "flora", status: "available", price: 350,
    blurb: "Sea nettles drifting through deep blue water." },
  { id: "first-bloom", title: "First Bloom", img: "first-bloom-12x12-oil-canvas", size: [12, 12], medium: "Oil on canvas", category: "flora", status: "available", price: 250,
    blurb: "Two cream-colored blossoms against a dark background, painted in thick oil." },
  { id: "camellias", title: "Camellias", img: "camellias-9x12-watercolor-on-paper", size: [9, 12], medium: "Watercolor on paper", category: "flora", status: "available", price: 150,
    blurb: "Pink camellias among dark green leaves." },
  { id: "a-new-day", title: "A New Day", img: "a-new-day-9x12-watercolor", size: [12, 9], medium: "Watercolor", category: "shore", status: "available", price: 150,
    blurb: "A coral sunrise over a quiet, rippled sea." },
  { id: "flying-south", title: "Flying South", img: "flying-south-9x12-watercolor-on-paper", size: [9, 12], medium: "Watercolor on paper", category: "shore", status: "available", price: 150,
  ...
  { id: "girl-with-a-pearl-earring", title: "Girl with a Pearl Earring", subtitle: "after Vermeer", img: "version-of-girl-with-a-pearl-earring-sold", size: null, medium: "Acrylic", category: "tables", status: "sold",
    blurb: "A version of Vermeer's portrait." },
];
